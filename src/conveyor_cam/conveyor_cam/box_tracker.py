...
class BoxTracker(Node):
    def __init__(self):
        ...
        # ==================================================
        # CAMERA INTRINSIC CALIBRATION - HARD CODED
        # ==================================================
        ...
        # ARUCO MARKER SETUP
        # ==================================================
        # Required marker layout:
        # ID 3 = Bottom Right = Origin
        # ID 2 = Upper Right
        # ID 1 = Bottom Left
        # ID 0 = Upper Left
        self.marker_pixels = {
        ...
        self.physical_pts = np.array([
            [0.0, 0.0],       # ID 3: Bottom Right / Origin
    ...
    def process_frame(self):
        ...
        # Apply intrinsic calibration correction first
        ...
        if all(pt is not None for pt in self.marker_pixels.values()):
            src_pts = np.array([
                self.marker_pixels[3],  # Bottom Right / Origin
                self.marker_pixels[2],  # Upper Right
                self.marker_pixels[1],  # Bottom Left
                self.marker_pixels[0]   # Upper Left
            ], dtype="float32")
                    ...
                    if 0.4 < aspect_ratio < 2.5:
                        ...
                        if self.transform_matrix is not None:
                            ...
                            if -2.0 <= real_x <= 103.0 and -2.0 <= real_y <= 27.5:
                                ...
                                label = f"{name} X:{real_x:.1f} Y:{real_y:.1f}"
